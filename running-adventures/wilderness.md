...
The party stops to set up camp. This is the time to stave off Deprivation (see [Healing & Recovery]({{ '/rules#healing--recovery' | relative_url }})) by cooking, eating, and sleeping.
...
| --- | --- | --- |
| 1 | Encounter | Roll for an encounter for the terrain or location. Don’t forget to roll for terrain (see below), surprise, and NPC reactions. (See [Before The Fight Starts]({{ '/combat#before-the-fight-starts' | relative_url }}).) |
