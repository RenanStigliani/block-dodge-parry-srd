...
Se você quiser apoiar o desenvolvimento contínuo de Block, Dodge, Parry e ter acesso ao elegante PDF completo (imprimível e fácil de consultar), a todas as explicações adicionais, ferramentas, comentários e exemplos da versão completa ilustrada, você pode encontrá-lo em
...
&lt;a href="https://dicegoblingames.itch.io/block-dodge-parry"&gt;Block, Dodge, Parry - A Levelless, Classless Expansion of Cairn by Dice Goblin Games&lt;/a&gt;

## Mais Block, Dodge, Parry

Veja [dicegoblin.blog](https://dicegoblin.blog/) para conhecer mais do meu trabalho, e as [postagens relacionadas](https://dicegoblin.blog/category/block-dodge-parry/).

## Discord

[Discord](https://discord.gg/zB9PhT3chT)
